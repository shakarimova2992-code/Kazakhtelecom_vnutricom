  ...
  function bindModDetail() {
    ...
    document.getElementById("modGenerateBtn").addEventListener("click", async () => {
      ...
      try {
        ...
        console.warn("ИИ-генерация недоступна, использован шаблон:", err.message);
      ...
      noteEl.textContent = t(usedAI ? "mod_ai_used" : "mod_ai_fallback", currentLang);
      noteEl.className = usedAI ? "ai-source-note ai-source-ok" : "ai-source-note ai-source-warn";
      noteEl.hidden = false;
